...
/**
 * Tests of {@link interpolation.api.InterpolationMethod}.
 *
 * TODO: replace the example testcases with your own testcases
 */

public class InterpolationMethodProcessorTest {
    ...
    public void init() {
        ...
        compileTestBuilder = Cute
                .blackBoxTest()
                .given()
                .processors(InterpolationMethodProcessor.class);
    }
    ...
    public void test_invalid_usage_with_empty_value() {
        ...
        compileTestBuilder
                ...
                .andThat().compilerMessage().ofKindError().contains(InterpolationMethodProcessorCompilerMessages.ERROR_VALUE_MUST_NOT_BE_EMPTY.getCode())
                .executeTest();
    }
